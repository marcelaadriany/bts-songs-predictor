...
public class DataSeeder implements CommandLineRunner {
  ...
  private void seedAlbumsAndSongs() {
    ...
    addSong(album2, "IF I RUlE THE WORLD");
    ...
    addSong(album10, "BLOOD SWEAT AND TEARS");
